...
<div class="row mb-3">
    <div class="col-12">
        ...
        <p class="text-muted">Pantauan Volume Performa & Ketahanan Stok Jaringan Dealer</p>
    </div>
</div>
...
<div class="row mt-3">
    ...
    <div class="col-md-6">
        <div class="card shadow-sm border-0 h-100">
            ...
            <div class="card-body p-0">
                <table class="table table-hover table-striped table-sm mb-0">
                    <thead class="bg-light text-muted"><tr><th class="pl-4">Dealer</th><th class="text-right pr-4">Total Qty</th></tr></thead>
                    <tbody>
                        @forelse($data['topCabangQty'] as $cab)
                        <tr><td class="pl-4 align-middle font-weight-bold">{{ $cab->nama_lokasi }}</td><td class="text-right pr-4"><h6 class="text-dark font-weight-bold mb-0">{{ number_format($cab->qty, 0, ',', '.') }}</h6></td></tr>
                        @empty
                        <tr><td colspan="2" class="text-center text-muted py-4">Data kosong.</td></tr>
                        @endforelse
                    </tbody>
    ...
    <div class="col-12">
        <div class="card card-outline card-danger shadow-sm border-0">
            <div class="card-header bg-white pb-2">
                <h3 class="card-title font-weight-bold"><i class="fas fa-exclamation-triangle text-danger mr-2"></i> Monitoring Stok Dealer Aktif</h3>
            </div>
                ...
                <table class="table table-sm table-striped table-hover table-head-fixed text-nowrap">
                    ...
                    <tbody>
                        ...
                        <tr class="{{ $stok->total_qty < $stok->stok_minimum ? 'table-danger' : '' }}">
                            <td class="align-middle pl-4"><span class="d-block text-bold">{{ $stok->nama_lokasi }}</span></td>
                        ...
                        <tr>
                            <td colspan="6" class="text-center text-muted py-4">
                                ...
                                Stok jaringan dealer dalam keadaan aman.
                            </td>
                        </tr>
                        @endforelse
                    </tbody>
