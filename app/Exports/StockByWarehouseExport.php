    ...
    WithStyles, WithEvents, WithCustomValueBinder
{
    ...
    public function __construct($lokasi_id, $canSeeSellingIn, $canSeeSellingOut)
    {
    ...
    {
        // Kolom B adalah Kode Barang (Paksa jadi text)
        if ($cell->getColumn() === 'B') {
    ...
    public function styles(Worksheet $sheet)
    {
        return [
            1 => [
                ...
                'fill' => ['fillType' => Fill::FILL_SOLID, 'startColor' => ['argb' => '0D9488']], // Biru Teal
